  ...
  return (
    <div className="container text-center px-4 py-8 bg-white max-w-5xl mx-auto">
      <div className="max-w-2xl text-center mx-auto sm:mt-20 mt-2">
        <p className="mx-auto mb-5 w-fit rounded-2xl border px-4 py-1 text-sm text-slate-500 bg-[#001f3f] text-white">
        ...
        <h1 className="mb-6 text-balance text-5xl font-bold text-zinc-800">
          Visualise Your Menu With AI
        </h1>
      </div>
      <div className="max-w-3xl text-center mx-auto text-[#001f3f]">
        <p className="mb-8 text-lg text-gray-500 text-balance ">
          Upload a photo of your menu and get images of each dish so you can
          ...
          <>
            ...
            >
             ...
             <div
               {...getRootProps()}
               className={`
                 mt-2 flex aspect-video cursor-pointer items-center justify-center
                 rounded-3xl border-2 border-dashed
                 ${isDragAccept ? "border-blue-500" : "border-[#001f3f]"}
               `}
             >
                  <input {...getInputProps()} />
                    ...
                    <div className="mt-4 flex text-sm leading-6 text-gray-600">
                      ...
                      >
                        ...
                        <p className="mt-2 font-normal text-gray-600">
                          Drag your image into the dropbox or simply take a photo
                        </p>
                      </label>
                    </div>
                  </div>
